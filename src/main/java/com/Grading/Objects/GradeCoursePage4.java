...
public class GradeCoursePage4 extends TestBaseGrade{
	...
	@FindBy(xpath="//td[@class='hidden-xs hideinmobile']//button[@class='btn btn-primary activecoursebutton btn-block' and @role='button']")	
...
public void activateCourse() throws InterruptedException {
	...
	public void courseAttributesVerification()
	{
		...
		softAssert.assertEquals(InitialStatus.isDisplayed(), false);
	...
	public void clickOnAlert()
	{
		 ...
		 * System.out.println("Alert box is visible"); alert.accept();
	...
	//As per the updated test case document below 3 functions are not useful for current tests:
	...
	public void selectFinalGradeForAll()
	{
	  ...
	  //Page 5: //As per the updated test case document below 3 methods are not useful for current tests:
